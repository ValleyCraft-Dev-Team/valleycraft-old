...
public class SimpleConfig {
    ...
    public SimpleConfig(String name, int version) {
        ...
        try {
            ...
            ValleyMain.LOGGER.warn("Error when reading file config: " + file.getName());
            map.clear();
        }
    ...
    public void flush() {
        ...
        try (PrintWriter printer = new PrintWriter(file, StandardCharsets.UTF_8)) {
            var printLine = false;
            ...
            ValleyMain.LOGGER.warn("Error when writing file config: " + file.getName());
        }
    }
