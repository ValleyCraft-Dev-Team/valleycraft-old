...
public class SmallCactusBlock extends HorizontalFacingBlock {
    protected static final VoxelShape OUTLINE_SHAPE = Block.createCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 13.0D, 14.0D);
    private static final VoxelShape COLLISION_SHAPE = VoxelShapes.empty();
