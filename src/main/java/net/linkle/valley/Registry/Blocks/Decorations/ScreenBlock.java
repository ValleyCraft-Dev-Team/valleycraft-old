...
public class ScreenBlock extends FacingBlock implements Waterloggable {
    ...
    static {
        ...
        UP_SHAPE = Block.createCuboidShape(0,0,0,16,20,1);
        DOWN_SHAPE = Block.createCuboidShape(0,0,0,16,20,1);
