...
import static net.linkle.valley.Registry.Initializers.MiscItems.AMERANTH;

public class AmeranthCropBlock extends PlantBlock implements Fertilizable {
    public static final IntProperty AGE;
    private static final VoxelShape SMALL_SHAPE;
    private static final VoxelShape LARGE_SHAPE;

    public AmeranthCropBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!bl && player.getStackInHand(hand).getItem() == Items.BONE_MEAL) {
            ...
            int j = 1 + world.random.nextInt(7);
            dropStack(world, pos, new ItemStack(AMERANTH, 1));
