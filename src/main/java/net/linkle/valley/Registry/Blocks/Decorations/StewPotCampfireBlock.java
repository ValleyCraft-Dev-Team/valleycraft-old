...
public class StewPotCampfireBlock extends FacingBlock implements Waterloggable {
    ...
    static {
        ...
        UP_SHAPE = Block.createCuboidShape(4.0D, -3.0D, 4.0D, 12.0D, 2.0D, 12.0D);
        DOWN_SHAPE = Block.createCuboidShape(4.0D, -3.0D, 4.0D, 12.0D, 2.0D, 12.0D);
        EAST_SHAPE = Block.createCuboidShape(4.0D, -3.0D, 4.0D, 12.0D, 2.0D, 12.0D);
        WEST_SHAPE = Block.createCuboidShape(4.0D, -3.0D, 4.0D, 12.0D, 2.0D, 12.0D);
        NORTH_SHAPE = Block.createCuboidShape(4.0D, -3.0D, 4.0D, 12.0D, 2.0D, 12.0D);
        SOUTH_SHAPE = Block.createCuboidShape(4.0D, -3.0D, 4.0D, 12.0D, 2.0D, 12.0D);
    }
