...
public class PlantFeatures {
    ...
    private static final RegistryKey<PlacedFeature> BUSH_PATCH = create("bush_patch", BUSH, 7);
    private static final RegistryKey<PlacedFeature> HOLLY_PATCH = create("holly_patch", HOLLY_BUSH.getDefaultState().with(BerryBushBlock.AGE, 2), 1);
    private static final RegistryKey<PlacedFeature> MOREL_PATCH = create("morel_patch", MOREL, 3);
    private static final RegistryKey<PlacedFeature> HONEYCLUSTER_PATCH = create("honey_cluster_patch", HONEY_CLUSTER, 2);
    private static final RegistryKey<PlacedFeature> PAN_PATCH = create("panflower_patch", PANFLOWER, 1);
    private static final RegistryKey<PlacedFeature> CROCUS_PATCH = create("crocus_patch", CROCUS, 3);
    private static final RegistryKey<PlacedFeature> TAPROOT_PATCH = create("taproots_patch", TAPROOTS, 1);
    private static final RegistryKey<PlacedFeature> FLOWERING_CACTUS_PATCH = create("flowering_cactus_patch", FLOWERING_CACTUS, 3);
    private static final RegistryKey<PlacedFeature> SPROUT_PATCH = create("sprout_patch", SPROUT, 3);
    private static final RegistryKey<PlacedFeature> ROSE_PATCH = create("rose_patch", ROSEBUSH, 1);
    private static final RegistryKey<PlacedFeature> LILAC_PATCH = create("lilac_patch", LILACBUSH, 1);
    private static final RegistryKey<PlacedFeature> PEONY_PATCH = create("peony_patch", PEONYBUSH, 1);
    private static final RegistryKey<PlacedFeature> TUMBLE_PATCH = create("tumbleweed_patch", TUMBLE_WEED, 1);
    private static final RegistryKey<PlacedFeature> CACTUS_PATCH = create("small_patch", SMALL_CACTUS, 2);
    private static final RegistryKey<PlacedFeature> ROCK_PATCH = create("rock_patch", ROCK_PILE, 8);
    private static final RegistryKey<PlacedFeature> SNOW_ROCK_PATCH = create("noname", SNOW_ROCK_PILE, 10);
    private static final RegistryKey<PlacedFeature> ALIVE_PATCH = create("alive_patch", BUSH_ALIVE, 10);
    private static final RegistryKey<PlacedFeature> BITTER_PATCH = create("bitter_patch", BITTER_BERRY_BUSH.getDefaultState().with(BerryBushBlock.AGE, 3), 2);
    private static final RegistryKey<PlacedFeature> TOMATO_PATCH = create("tomato_patch", TOMATO_BUSH.getDefaultState().with(BerryBushBlock.AGE, 2), 1);
    private static final RegistryKey<PlacedFeature> SNOW_PATCH = create("snow_bush_patch", SNOW_BUSH, 10);
    private static final RegistryKey<PlacedFeature> WHEAT_PATCH = create("wheat_patch", WILD_WHEAT, 1);
    private static final RegistryKey<PlacedFeature> CARROT_PATCH = create("carrot_patch", WILD_CARROT, 1);
    private static final RegistryKey<PlacedFeature> BEET_PATCH = create("beet_patch", WILD_BEET, 1);
    private static final RegistryKey<PlacedFeature> POTATO_PATCH = create("potato_patch", WILD_POTATO, 1);
    private static final RegistryKey<PlacedFeature> WILLOW_PATCH = create("willow_patch", WEAPING_SWAMP_WILLOW, 2);
    private static final RegistryKey<PlacedFeature> RIBBON_PATCH = create("ribbon_patch", SWAMP_RIBBON, 12);
    private static final RegistryKey<PlacedFeature> DAHLIA_PATCH = create("black_dahlia_patch", BLACK_DAHLIA, 8);
    private static final RegistryKey<PlacedFeature> LAVENDER_PATCH = create("lavender_patch", LAVENDER, 8);
    private static final RegistryKey<PlacedFeature> ORANGE_FERN_PATCH = create("orange_fern_patch", ORANGE_FERN, 5);
    private static final RegistryKey<PlacedFeature> ORANGE_BEAUTY_PATCH = create("orange_beauty_patch", ORANGE_BEAUTY, 2);
    private static final RegistryKey<PlacedFeature> SORREL_PATCH = create("sorrel_patch", REDWOOD_SORREL, 5);
    private static final RegistryKey<PlacedFeature> DANDELION_PATCH = create("dandelion_patch", DANDELION_PUFF, 2);
    private static final RegistryKey<PlacedFeature> JUNGLE_CAP_PATCH = create("jungle_cap_patch", JUNGLE_CAP, 1);
    private static final RegistryKey<PlacedFeature> SWAMP_BUSH_PATCH = create("js_bush_patch", SWAMP_BUSH, 7);
    private static final RegistryKey<PlacedFeature> HERB_PATCH = create("herbs_patch", HERBS, 1);
